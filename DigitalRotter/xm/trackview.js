...
function redrawScreen() {
  ...
  if (e.scopes !== undefined) {
    ...
    var canvas = document.getElementById("xmvu");
  ...
  if (e.row != shown_row || e.pat != pat_canvas_patnum) {
    ...
    var gfx = document.getElementById("xmgfxpattern");
...
function init() {
  var title = document.getElementById("xmtitle");
  ...
  var instrlist = document.getElementById("xminstruments");
  ...
  document.getElementById('xmvu').width = _pattern_border +
    _pattern_cellwidth * player.xm.nchan;
  var gfxpattern = document.getElementById("xmgfxpattern");
